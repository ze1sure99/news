package com.ze1sure99.api.config;
...
//        Predicate<RequestHandler> articlePredicate = RequestHandlerSelectors.basePackage("com.imooc.article.controller");
        Predicate<RequestHandler> userPredicate = RequestHandlerSelectors.basePackage("com.ze1sure99.user.controller");
//        Predicate<RequestHandler> filesPredicate = RequestHandlerSelectors.basePackage("com.imooc.files.controller");
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("听闻·自媒体接口api")                       // 文档页标题
                .contact(new Contact("Alex",
                        "https://ze1Sure99.github.io",
                        "zhaozixuhen@abchina.com"))                   // 联系人信息
                .description("专为听闻·自媒体平台提供的api文档")      // 详细信息
                .version("1.0.0")                               // 文档版本号
                .termsOfServiceUrl("https://www.ze1sure99.com")     // 网站地址
                .build();
    }
